...
export default function MergeSheets() {
  ...
  const handleMerge = useCallback(async () => {
    ...
    if (!hasSelectedSheets) {
      setError("Select at least one sheet to merge.");
      return;
    }
  ...
  }, [file, hasSelectedSheets, outputSheet, selectedSheets]);
      ...
      {preview && (
        ...
        >
          <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
            <div>
              <h3 className="font-medium">Select Sheets</h3>
            ...
            >
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 text-xs md:grid-cols-4">
                ...
                >
                  <div>Order mode</div>
                  <div className="font-medium" style={{ color: "var(--foreground)" }}>
                    {isWorkbookOrder ? "Workbook" : "Custom"}
                  </div>
                </div>
                <div
                  className="rounded border px-2 py-1"
                  ...
                  <button
                    ...
                    aria-label={
                      isMergeOrderExpanded
                        ? "Collapse merge order"
                        : "Expand merge order"
                    }
                  >
                    <span className="inline-flex items-center gap-1.5 leading-none">
                      {isMergeOrderExpanded ? "Collapse" : "Expand"}
                      {isMergeOrderExpanded ? (
