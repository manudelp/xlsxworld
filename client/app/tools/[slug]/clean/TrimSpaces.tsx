...
export default function TrimSpaces() {
  ...
  return (
    <div className="space-y-4">
      <FileUploadDropzone
        accept={EXCEL_ACCEPT}
        message="Drop or select an Excel file to trim spaces"
        hasError={!!error}
        onFiles={(files) => {
      ...
      {preview ? (
        ...
        >
          <div>
            <h3 className="font-medium">Trim extra spaces</h3>
            <p className="text-sm" style={{ color: "var(--muted-2)" }}>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              />
              <span>Also reduce repeated spaces inside text</span>
            </label>
          </div>
            ...
            <button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  setError(
                    e instanceof Error ? e.message : "Could not trim spaces",
                  );
                } finally {
                  setLoading(false);
                }
