...
export default function FindReplace() {
  ...
  return (
    <div className="space-y-4">
      <FileUploadDropzone
        accept={EXCEL_ACCEPT}
        message="Drop or select an Excel file to run find and replace"
        hasError={!!error}
        onFiles={(files) => {
      ...
      {preview ? (
        ...
        >
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div>
              <h3 className="font-medium">Find & replace settings</h3>
              <p className="text-sm" style={{ color: "var(--muted-2)" }}>
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <label className="block text-sm" style={{ color: "var(--muted)" }}>
              ...
              <input
                ...
                placeholder={useRegex ? "e.g. \\b(inc|llc)\\b" : "Text to find"}
            ...
            <button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  setError(e instanceof Error ? e.message : "Could not run find and replace");
                } finally {
                  setLoading(false);
                }
              }}
