...
export default function NormalizeCase() {
  ...
  return (
    <div className="space-y-4">
      <FileUploadDropzone
        accept={EXCEL_ACCEPT}
        message="Drop or select an Excel file to normalize text case"
        hasError={!!error}
        onFiles={(files) => {
      ...
      {preview ? (
        ...
        >
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div>
              <h3 className="font-medium">Case normalization settings</h3>
              <p className="text-sm" style={{ color: "var(--muted-2)" }}>
            ...
            <button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  setError(e instanceof Error ? e.message : "Could not normalize case");
                } finally {
                  setLoading(false);
                }
              }}
